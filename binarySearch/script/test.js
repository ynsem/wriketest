...
describe("binarySearch", function () {
    ...
    // 11
    it("Возвращает текстовое сообщение если массив несортирован (вариант 1)", function () {
        assert.equal(binarySearch(2, [0, 2, 1, 9, 7, 18, 5, 4]), "Не подходит для бинарного поиска");
    });
    it("Возвращает текстовое сообщение если массив несортирован (вариант 2)", function () {
        assert.equal(binarySearch(18, [0, 2, 1, 9, 7, 18, 5, 4]), "Не подходит для бинарного поиска");
    });
    // 12
