...
describe("binarySearch", function () {
    ...
    // 14
    it("Возвращает позицию элемента, если в массиве есть повторяющиеся элементы", function () {
        assert.equal(binarySearch(2, [0, 1, 1, 2, 3, 4, 5, 6]), 4);
    });
    it("Возвращает позицию элемента, если в массиве есть повторяющиеся элементы", function () {
        assert.equal(binarySearch(1, [0, 1, 1, 2, 3, 4, 5, 6]), 2);
    });
});